    ...
    <div className="">
      <section className="bg-gray-400 flex flex-col items-center justify-center">
        ...
        <section className="text-center px-4 lg:px-6 md:flex-row md:text-start md:gap-8">
          ...
          <div 
  className="w-full h-[400px] sm:h-[350px]  md:w-[400px] bg-center bg-cover  mt-6 md:mt-0 md:-ml-40" 
  style={{
...
></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-8 p-4 md:p-6 w-full max-w-7xl">
          <div
            className="w-full h-[350px] md:w-[400px] md:h-[300px] bg-center bg-cover z-0"
            style={{
              backgroundImage: "url('/src/assets/image/pic1.jpg')",
            }}
          ></div>
          <div className="bg-transparent md:bg-white/40 rounded-full p-4 md:p-6 w-full md:w-[700px] md:h-[250px] z-10 md:-ml-20">
